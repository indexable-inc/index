...
pub struct McpRuntimeInput {
    ...
    /// Sink for servers' channel notifications (`notifications/claude/channel`,
    /// `notifications/codex/channel`); `None` drops them.
    pub notification_handler: Option<McpNotificationHandlerHandle>,
}
